...
export const SidebarMenu = () => {
  ...
  return (
    <div className="p-4 mt-5 bg-gray-100 lg:w-64 rounded-lg shadow-lg">
      ...
      >
        ...
        <i className={`text-gray-500 fa-solid ${openSection === 'price' ? 'fa-caret-down' : 'fa-caret-right'}`}></i>
      </button>
      {openSection === 'price' && <div className="p-4 bg-gray-200 rounded-md mb-2">Hola</div>}
      ...
      >
        ...
        <i className={`txt text-gray-500 fa-solid ${openSection === 'category' ? 'fa-caret-down' : 'fa-caret-right'}`}></i>
      </button>
      {openSection === 'category' && <div className="p-4 bg-gray-200 rounded-md mb-2">Hola.</div>}
      ...
      >
        ...
        <span className='txt font-bold text-gray-500 text-sm'>Subcategory</span>
        </div>
        <i className={`text-gray-500 fa-solid ${openSection === 'subcategory' ? 'fa-caret-down' : 'fa-caret-right'}`}></i>
      </button>
      {openSection === 'subcategory' && <div className="p-4 bg-gray-200 rounded-md mb-2">Jola</div>}
      ...
      >
        ...
        <i className={`text-gray-500 fa-solid ${openSection === 'brand' ? 'fa-caret-down' : 'fa-caret-right'}`}></i>
      </button>
      {openSection === 'brand' && <div className="p-4 bg-gray-200 rounded-md mb-2">Hola</div>}
